...
///This class is the component user interacts to constrol the TransportPlayer
...
public:
    ...
    ///This funcion is called when the playbutton is clicked
    ...
    ///This functon changes the pausebutton to playbutton
